...
\subsection{An Oracle Example}
 ...
 design patterns for Ergo contracts. Assume that Alice and Bob are going to bet on weather tomorrow. For that, they are putting money into a box, which is spendable by
