...
private[nodeView] class DigestNodeViewHolder(settings: ErgoSettings,
                                             ...
                                             emission: CoinsEmission,
                                             modifiersCache: ErgoModifiersCache)
  extends ErgoNodeViewHolder[DigestState](settings, timeProvider, emission, modifiersCache)

private[nodeView] class UtxoNodeViewHolder(settings: ErgoSettings,
                                           timeProvider: NetworkTimeProvider,
                                           emission: CoinsEmission,
                                           modifiersCache: ErgoModifiersCache)
  extends ErgoNodeViewHolder[UtxoState](settings, timeProvider, emission, modifiersCache)
...
(implicit ev: StateType.Evidence[ST, S]) {
  def apply(settings: ErgoSettings, timeProvider: NetworkTimeProvider, digestType: ST, emission: CoinsEmission,
            modifiersCache: ErgoModifiersCache): Props
}
...
object DigestNodeViewProps extends ErgoNodeViewProps[StateType.DigestType, DigestState, DigestNodeViewHolder] {
  def apply(settings: ErgoSettings,
            ...
            emission: CoinsEmission,
            modifiersCache: ErgoModifiersCache): Props =
    Props.create(classOf[DigestNodeViewHolder], settings, timeProvider, emission, modifiersCache)
}
...
object UtxoNodeViewProps extends ErgoNodeViewProps[StateType.UtxoType, UtxoState, UtxoNodeViewHolder] {
  def apply(settings: ErgoSettings,
            ...
            emission: CoinsEmission,
            modifiersCache: ErgoModifiersCache): Props =
    Props.create(classOf[UtxoNodeViewHolder], settings, timeProvider, emission, modifiersCache)
}
