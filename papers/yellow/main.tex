...
Each register is an expression in \sigma language. Thus the registers are typed: every register contains a value of
...
\begin{itemize}
    ...
    \item{\em bytes of a script. } To see how the script is serialized, see (\knote{link to sigma language expressions
    ...
    serialized as a \sigma expression.
    ...
    are to be concatenated into a single array of 34 bytes and wrapped into \sigma language constant stored in the
    register $R2$.
\end{itemize}
