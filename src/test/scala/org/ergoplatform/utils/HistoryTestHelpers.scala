...
object HistoryTestHelpers extends FileUtils {
  ...
  def generateHistory(verifyTransactions: Boolean,
    ...
    val nodeSettings: NodeConfigurationSettings = NodeConfigurationSettings(stateType, verifyTransactions, blocksToKeep,
      UtxoSettings(false, 0, 2), NipopowSettings(false, 1), mining = false, txCostLimit, txSizeLimit, blockCandidateGenerationInterval = 30.seconds, useExternalMiner = false,
