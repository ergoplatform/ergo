...
We introduce \extract{} function, which is reading contents of a register, for example, \extract{R_0} extracts monetary value
of a \coin{}.
...
We require transaction to preserve overall monetary value:
