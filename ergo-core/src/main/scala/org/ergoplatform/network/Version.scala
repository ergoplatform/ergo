...
object Version {
  ...
  val SubblocksVersion: Version = Version(5, 0, 0)  // todo: set to proper value before activation, to send input block related messages only to peers able to parse them
