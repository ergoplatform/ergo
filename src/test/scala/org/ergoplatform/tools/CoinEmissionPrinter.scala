...
object CoinEmissionPrinter extends App {
  ...
  val emissionCurve = new EmissionRules(MonetarySettings(10080, 2160, 7500000000L, 300000000, 720, "b9deff2a27d270e0978e1814f9a62d1bf8092521042fd2b0c531b59629c586ff01"))
