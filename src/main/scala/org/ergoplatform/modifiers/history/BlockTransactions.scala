...
import org.ergoplatform.modifiers.{BlockTransactionsTypeId, ModifierTypeId, NonHeaderBlockSection}
...
object BlockTransactions extends ApiCodecs {
  ...
  val modifierTypeId: ModifierTypeId.Value = BlockTransactionsTypeId.value
