...
dependencyOverrides in ThisBuild ++= Seq(
  ...
  "org.scorexfoundation" % "sigma-impl_2.12" % "soft-forkability2-c4824a5e-SNAPSHOT",
  "org.scorexfoundation" % "sigma-library_2.12" % "soft-forkability2-c4824a5e-SNAPSHOT",
  "org.scorexfoundation" % "sigma-state_2.12" % "soft-forkability2-c4824a5e-SNAPSHOT",
