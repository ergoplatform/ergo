...
\begin{document}
    ...
    \author{Vasily Kharin\inst{3}, Alexander Chepurnoy\inst{1,2}, Dmitry Meshkov\inst{1}}
...
%    \begin{abstract}
%        This document contains description of concrete PoW protocol, that will be used in Ergo
%    \end{abstract}
