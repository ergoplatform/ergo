...
dependencyOverrides in ThisBuild ++= Seq(
  ...
  "org.scorexfoundation" % "scorex-core_2.12" % "aeba676f-SNAPSHOT",
  "org.scorexfoundation" % "scorex-util_2.12" % "0.1.1-SNAPSHOT",
  "org.scorexfoundation" % "scrypto_2.12" % "2.1.2",
  "org.scorexfoundation" % "sigma-state_2.12" % "0.9.5",
...
// LIBRARY_DEPENDENCIES_HASH a8b9064cbed54d0fab3f0e27c0cbbfba4ae7a446
