...
- a digest (Merkle tree root) of new first-class transactions since last input-block
- a digest (Merkle tree root) first class transactions since ordering block till last input-block
