...
\label{subsec:network-propagation-protocol}

\subsubsection{Announcement Phase}
...
\subsubsection{Data Retrieval Phase}
...
Proof-of-Work (cumulative difficulty) is considered as canonical. When a new block on the same height as best one
...
The same rules apply to input blocks...
