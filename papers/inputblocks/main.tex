...
In this section, we provide overview of input blocks design. Details then provided in the follow-up Implementation section.
...
automatically checked. As using miner public key makes a transactions belonging to second-class transactions, and such
transactions can be included into ordering blocks only, to utilize input blocks we need to introduce additional
...
\subsection{SPV and NiPoPoW clients}
