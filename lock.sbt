...
dependencyOverrides in ThisBuild ++= Seq(
  ...
  "org.scorexfoundation" % "scorex-core_2.12" % "4bc8c385-SNAPSHOT",
  "org.scorexfoundation" % "scorex-util_2.12" % "0.1.3",
  "org.scorexfoundation" % "scrypto_2.12" % "2.1.6",
  "org.scorexfoundation" % "sigma-state_2.12" % "new-serialization-78e4700d-SNAPSHOT",
...
// LIBRARY_DEPENDENCIES_HASH 71fa2783c9f50bfbd26fbd0044497967f35d6931
