\knote{this section is to be rewritten and split into protocol and impkementation parts}
...
The goal of NVS is to escort modifier step by step from \term{Unknown} state to \term{Held},
...
state to \term{Held} (remove this key from corresponding map since we can always get modifier state from History).
