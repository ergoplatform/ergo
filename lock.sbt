...
dependencyOverrides in ThisBuild ++= Seq(
  ...
  "io.github.scalan" % "common_2.12" % "master-b3370484-SNAPSHOT",
  "io.github.scalan" % "core_2.12" % "master-b3370484-SNAPSHOT",
  "io.github.scalan" % "library-api_2.12" % "master-b3370484-SNAPSHOT",
  "io.github.scalan" % "library-impl_2.12" % "master-b3370484-SNAPSHOT",
  "io.github.scalan" % "library_2.12" % "master-b3370484-SNAPSHOT",
  "io.github.scalan" % "macros_2.12" % "master-b3370484-SNAPSHOT",
  "io.github.scalan" % "meta_2.12" % "master-b3370484-SNAPSHOT",
  ...
  "org.ergoplatform" % "ergo-wallet_2.12" % "0.2-R1-SNAPSHOT",
  ...
  "org.scorexfoundation" % "scorex-core_2.12" % "i177_2-5eee62e8-SNAPSHOT",
  "org.scorexfoundation" % "scorex-util_2.12" % "0.1.3",
  "org.scorexfoundation" % "scrypto_2.12" % "2.1.6",
  "org.scorexfoundation" % "sigma-api_2.12" % "v2.1-b5a50364-SNAPSHOT",
  "org.scorexfoundation" % "sigma-impl_2.12" % "v2.1-b5a50364-SNAPSHOT",
  "org.scorexfoundation" % "sigma-library_2.12" % "v2.1-b5a50364-SNAPSHOT",
  "org.scorexfoundation" % "sigma-state_2.12" % "v2.1-b5a50364-SNAPSHOT",
...
// LIBRARY_DEPENDENCIES_HASH 06db570b00bee583ebcbefa996a5bf68eb50388c
