...
lazy val scorexVersion = "6a100ea0-SNAPSHOT"

lazy val baseSettings = Defaults.itSettings ++ Seq(
  ...
  licenses := Seq(
    "CC0" -> url("https://creativecommons.org/publicdomain/zero/1.0/legalcode"))
)
  ...
  project
    ...
    .settings(
      ...
      findbugsExcludeFilters := Some(
        scala.xml.XML.loadFile(baseDirectory.value / "findbugs-exclude.xml")),
      //Scapegoat settings
