...
condition as $T \le H(i) < t$, then a miner can generate on average 63 input blocks plus an ordering block
...
but an ordering block ($H < T$) also passes the input-block check.
