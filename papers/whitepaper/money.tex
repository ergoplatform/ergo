...
\dnote{I think we should add more information our AVL+ tree and it dynamic properties}

\dnote{Also it would be nice to discuss, why did we chose UTXO instead of account~(there are some words about it in intro)}
...
\dnote{This subsection looks unrelated to other subsections of this section, so I propose to extend it and extract to a separate section}
 ...
 instead of {\em coin}. Also, like in Ethereum, the ledger snapshot representation~(in the form of boxes not destroyed by
