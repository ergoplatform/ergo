...
object Version {
  ...
  val SubblocksVersion: Version = Version(6, 5, 0)  // todo: set to proper value before activation, to send input block related messages only to peers able to parse them
